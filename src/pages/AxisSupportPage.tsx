  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="space-y-8 text-[#a0a0a0] leading-relaxed">
        <section>
          <h2 className="text-white font-semibold mb-2">Report an Issue</h2>
          <p>
          ...
          <a
            ...
            className="inline-block mt-3 text-white underline underline-offset-4 hover:text-[#a0a0a0] transition-colors"
          >
        ...
        <section>
          <h2 className="text-white font-semibold mb-2">FAQ</h2>
          <div className="space-y-4">
            <div>
              <h3 className="text-white text-sm font-medium">Where are my files stored?</h3>
            ...
            <div>
              <h3 className="text-white text-sm font-medium">Does Axis require an internet connection?</h3>
              <p className="text-sm mt-1">
                No. Axis works entirely offline with no network requests.
              </p>
            </div>
            <div>
              <h3 className="text-white text-sm font-medium">How do I reset my preferences?</h3>
              <p className="text-sm mt-1">
                Delete the app preferences by running{" "}
                <code className="bg-[#1a1a1a] px-1.5 py-0.5 rounded text-xs">
